                    ...
                    <div className="row justify-content-around align-items-center">
                        ...
                        <div className="col-lg-4 col-md-6 footer-newsletter mb-5">
                            ...
                            <form action="/email" method="post">
                                <input type="email" name="email" placeholder="Seu melhor email" className="contact" />
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-info text-center">
                                ...
                                <p className="pb-4">Rua José Viturino Gomes - S/N</p>
                                <p className="pb-4">Mata Roma - MA</p>
